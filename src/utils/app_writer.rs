...
//     pub fn with_err_and_status(err: AppError, status: StatusCode) -> Self {
//         let msg = match &err {
//             AppError::AnyHow(e) => e.to_string(),
//             AppError::ParseError(e) => e.to_string(),
//             AppError::DbErr(e) => e.to_string(),
//             AppError::ValidationError(e) => e.to_string(),
//         };
//         Self {
//             code: status as u16,
//             msg,
